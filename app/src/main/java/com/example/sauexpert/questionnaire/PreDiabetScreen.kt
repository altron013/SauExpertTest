package com.example.sauexpert.questionnaire
...
fun PreDiabetScreen() {
    ...
    Column(
        ...
        Column(
            ...
            Text(text = stringResource(id = R.string.find_out_patients_diabet_risk),fontSize = 15.sp)
            Spacer(modifier = Modifier.padding(12.dp))
            AuthTextFiled(
                name = email, ErrorState = passwordErrorState, placeholder = stringResource(
            ...
            SimpleRadioButtonComponent(surveyQuestions)
            Spacer(modifier = Modifier.padding(9.dp))
            MainButton(
                onClick = { /*TODO*/ },
                enableState = true,
